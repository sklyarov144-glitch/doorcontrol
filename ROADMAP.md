...
- [ ] Завершить декомпозицию `LegacyApp` на независимые страницы и доменные модули.
  Все основные пользовательские страницы уже вынесены в автономные модули, а `LegacyApp` сокращён до orchestration-слоя с действующим app shell и переходным маршрутизатором. Для закрытия пункта нужно вынести оставшийся shell/router и обновить архитектурную документацию; текущие component/E2E-тесты подтверждают поведение вынесенных страниц и ролевые ограничения.
