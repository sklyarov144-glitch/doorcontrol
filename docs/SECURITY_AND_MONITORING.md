...
- Ответственные, исполнители, авторы, сотрудники бригад, нормативы, договоры и
  финансовые ссылки также проверяются на принадлежность компании владельца.
  Новое назначение требует активного пользователя нужной роли; деактивация
  сотрудника сохраняет историю и не блокирует завершение уже созданных записей.
